...
> **战略使命：建立可持续增长的知识型个人 IP，通过双平台内容矩阵积累专业影响力，实现双平台粉丝持续增长。**

一家由 AI Agent 驱动的 AI 独立开发者知识 IP 公司，覆盖抖音 + 小红书双平台；公司为自媒体运营公司，具体平台运营与 IP 打造按项目组织推进，持续分享 AI 相关内容、知识与实践经验，以流水线方式生产内容，并以数据驱动迭代。
...
- 公司以项目为组织单元推进平台运营与 IP 打造（如冷启动增长、生产线标准化等）
- 每个项目有明确目标、负责人、里程碑与复盘节点，跨角色协同交付
