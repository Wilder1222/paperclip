---
name: 自媒体内容工厂
description: 以个人知识 IP 建立为战略使命，通过 AI Agent 驱动的流水线工作流，在抖音、小红书双平台持续输出专业内容，将影响力转化为可持续的知识付费变现体系
...
mission: >
  建立可持续增长的知识型个人 IP，通过双平台内容矩阵积累专业影响力，
  构建从"内容曝光 → 受众信任 → 付费知识产品"的完整变现闭环。
goals:
  - 成为所在垂直领域抖音 + 小红书头部知识 IP（90 天基础期）
  - 每周 20 条双平台内容，爆款率 ≥ 15%
  - 建立付费社群/咨询/课程转化路径
  - 90 天内双平台粉丝净增 20k
---
...
> **建立可持续增长的知识型个人 IP，通过双平台内容矩阵积累专业影响力，构建从内容曝光到付费知识产品的变现闭环。**

本公司的存在不是为了发内容，而是为了**建立一个真实的、可信任的专业人格（IP）**。内容是手段，影响力是护城河，知识付费是变现出口。
...
| **变现层** | 付费知识产品闭环 | 内容→私信→付费咨询/社群/课程 |

---

## 90 天 OKR

### Objective：成为所在垂直领域抖音 + 小红书头部知识 IP
...
| KR4（变现） | 知识付费转化路径建立 | 付费咨询 / 社群 / 课程 至少 1 条路径上线 |
