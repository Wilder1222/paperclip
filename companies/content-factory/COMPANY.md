---
name: 自媒体内容工厂
description: AI 独立开发者知识 IP 公司——以 AI 独立开发者身份，通过 AI Agent 驱动的流水线工作流，在抖音、小红书双平台持续分享 AI 相关内容、知识与实践经验，将专业影响力转化为可持续的知识付费变现体系
...
mission: >
  ...
  知识与实践经验，积累专业影响力，构建从"内容曝光 → 受众信任 → 付费知识产品"的完整变现闭环。
goals:
...
> **以 AI 独立开发者身份建立可持续增长的知识型个人 IP，通过双平台内容矩阵持续分享 AI 相关内容、知识与实践经验，积累专业影响力，构建从内容曝光到付费知识产品的变现闭环。**

本公司的存在不是为了发内容，而是为了**建立一个真实的、可信任的 AI 独立开发者专业人格（IP）**。内容是手段，影响力是护城河，知识付费是变现出口。
