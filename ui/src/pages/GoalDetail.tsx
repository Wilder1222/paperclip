    ...
    return (
        <div className="space-y-6">
            <div className="space-y-3">
                ...
                {goalProgress && (
                    <div className="pt-1">
                        <GoalProgressBar counts={goalProgress.total} />
                        {goalProgress.activeAgentIds.length > 0 && (
                            <p className="mt-1 text-xs text-blue-500">
                                {goalProgress.activeAgentIds.length} agent
                                {goalProgress.activeAgentIds.length > 1 ? "s" : ""} active
                            </p>
                        )}
                    </div>
                )}
