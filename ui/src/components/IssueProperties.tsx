...
import type { Issue, IssueLabel, IssueWorkProduct, Project, WorkspaceRuntimeService } from "@paperclipai/shared";
...
function WorkProductTypeIcon({ type, className }: { type: IssueWorkProduct["type"]; className?: string }) {
    switch (type) {
        case "pull_request": return <GitPullRequest className={className} />;
        case "branch": return <GitBranch className={className} />;
        case "preview_url": return <Globe className={className} />;
        case "document": return <FileText className={className} />;
        case "artifact": return <FileText className={className} />;
        default: return <Package className={className} />;
    }
}

const WORK_PRODUCT_STATUS_LABELS: Partial<Record<string, string>> = {
    merged: "Merged",
    closed: "Closed",
    draft: "Draft",
    failed: "Failed",
