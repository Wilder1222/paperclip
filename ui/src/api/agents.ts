...
export const agentsApi = {
    ...
    listBench: (companyId: string) => api.get<CompanyStaffBenchEntry[]>(`/companies/${companyId}/staff-bench`),
    ...
    createBenchEntry: (companyId: string, data: CompanyStaffBenchCreateRequest) =>
        api.post<CompanyStaffBenchEntry>(`/companies/${companyId}/staff-bench`, data),
    activateBenchEntry: (companyId: string, entryId: string) =>
        api.post<CompanyStaffBenchActivationResult>(`/companies/${companyId}/staff-bench/${entryId}/activate`, {}),
